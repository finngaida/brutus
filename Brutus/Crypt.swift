...
public class Crypt: NSObject {
    ...
    public enum E:ErrorType {
        case ConversionError, UnicodeConversion(i: Any), NoKeysArray, CharacterUnknown(s:String), CouldntCrack, Unknown
    }
    ...
    public class func s2I(s:String, ascii:Bool) throws -> Int {
        if ascii {
            guard let f = s.unicodeScalars.first else { throw E.UnicodeConversion(i: 0) }
            return Int(f.value)
